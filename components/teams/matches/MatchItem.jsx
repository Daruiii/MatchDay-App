    ...
    <View key={match.id} style={styles.eventContainer(teamData?.eventColor, teamData?.secondColor)}>
      ...
      >
        <OptimizedImage 
          ...
          fallbackTextStyle={styles.eventText(teamData?.eventTextColor)}
        />
      </Pressable>
      ...
      <View style={styles.eventMatch}>
        ...
        {match?.status === 'running' ? (
          <Text style={styles.eventTextVS(teamData?.eventTextColor)}>
      ...
      <View style={styles.eventDateTime}>
        ...
        <View style={styles.eventGame}>
          {match?.videogame?.slug && gamesLogo[match.videogame.slug] && images[matchInfo.imgName] ? (
            <View style={styles.eventGameImg(teamData?.secondColor)}>
              <Image 
                source={images[matchInfo.imgName]} 
